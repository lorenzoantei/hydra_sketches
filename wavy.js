...
osc(20,-0.0018,0.17).diff(osc(20,0.00008).rotate(Math.PI/0.00003))
.modulateScale(noise(1.5,0.18).modulateScale(osc(13).rotate(()=>Math.sin(time/22))),3)
.color(()=>a.fft[0]*2,0.5,0.4, 0.9, 0.2, 0.011, 5, 22,  0.5, -1).contrast(1.4)
...
.modulateScale(osc(2),-0.2, 2, 1, 0.3)
 .modulatePosterize(200) .modulateRotate(1, 0.2, 0.01, 0.001)
